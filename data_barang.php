...
<body>
    ...
    <table border="1" cellpadding="6">
        ...
        <tr>
            ...
            <td>
                <a herf="edit_barang.php?id=<?php echo $row['id_barang']; ?>">Edit</a> |
                <a herf="hapus_barang.php?id=<?php echo $row['id_barang']; ?>"
                onclik="return confirm('Yakin hapus barang ini?');">Hapus</a>
            </td>
        </tr>
    <?php } ?>
</table>
