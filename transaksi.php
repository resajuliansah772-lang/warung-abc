...
<body>
    ...
    <form action="proses_tambah_keranjang.php" method="POST">
        ...
        Jumlah: <input="number" name="jumlah" min="1" required>
        <input type="submit" value="Tambah ke Keranjang">
    </form>

    <h3>Keranjang</h3>
    <table border="1" cellpadding="6">
        <tr><th>Nama Barang</th><th>Jumlah</th><th>Subtotal</th><th>Aksi</th><tr>
        ...
        <tr>
            ...
            <td><a herf="hapus_keranjang.php?id=<?php echo $id_barang; ?>">Hapus</a></td>
        </tr>
        <?php } ?>
